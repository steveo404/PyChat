...
while True:
    ...
    for notified_socket in read_sockets:
        ...
        # Else existing socket is sending a message
            ...
            #print("Received message from: {}: {}".format(clients[notified_socket]['data'].decode("utf-8"),receive_message[notified_socket]['data'].decode["utf-8"]))
            #print("Received message from: {}".format(user['data'].decode("utf-8")))
            #print("Message is: {}".format(user['data'].decode("utf-8")))
